...
2. Transfer to output buffer
3. Decoder pulls data off buffer
4. Decoder to aux
*/
...
//MP3 Project
	 ...
	 //    LPC_GPIO1->FIOCLR = (1<<28);    //set pin P1.28 low initially to reset
	 ...
	 //   	LPC_GPIO1->FIOSET = (1<<22);    //set pin P1.22 high initially
		...
		//Assert xReset of the VS1053 and then disassert
